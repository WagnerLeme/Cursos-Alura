...
Route::get('/temporadas/{temporada}/episodios', 'EpisodioController@index');

Route::post('/temporadas/{temporada}/episodios/assistir', 'EpisodioController@assistir') -> middleware('autenticador');
